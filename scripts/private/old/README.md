...
folder `angular-medixx-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `angular-medixx-snapshots` folder, containing
...
The medic data used by the application is scraped from a Google search page.

- ScrapeData.js: Run this script using node.js to access the web page containing the medic data and
  copy the data into the `app/medics` folder.
